...
namespace ModuloAplicacion.SubmoduloDB.Formularios
{
    public partial class RH : Form
    {
        ...
        private void RH_Load(object sender, EventArgs e)
        {
            ...
            this.toolStripStatusLabel1.Text = "RH.cs"+ " | " + "Usuario: " + ModuloAplicacion.SubmoduloPresentacion.Formularios.Presentacion.xNombreUsuarioSesion.Trim() + " | " + "Fecha: " + DateTime.Now.Day + "/" + DateTime.Now.Month + "/" + DateTime.Now.Year;
        }
        /*............Funciones..........................*/
    }
}
